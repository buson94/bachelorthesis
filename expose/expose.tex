...
\begin{document}
    ...
    \begin{itemize}
        \item Wie beeinflusst die Wahl der Persistenz-Technologie (relationale vs. NoSQL-Datenbanken) die Performance und Skalierbarkeit des Planspiels?
        \item Welche Herausforderungen treten bei der Persistenz von Echtzeitdaten auf (in Bezug einer späteren Mehrspielerfunktion)?
        \item Wie kann die Persistenz in dem Planspiel ressourcenschonend und energieeffizient gestaltet werden?
    \end{itemize}
