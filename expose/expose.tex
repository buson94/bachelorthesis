...
\begin{document}
    ...
    Um die Möglichkeit einer Mehrspielerfunktion zu bewahren, sollte eine Spielsitzung auf einem Server erfolgen. Dabei kann man Entweder den Webserver nutzen, auf dem auch das Planspiel läuft oder über Technologien wie Peer-to-Peer z. B. den Spielleiter als Server definieren. 
